...
namespace library {
	...
	// engine interface
	extern "C" __declspec(dllexport) engine::Engine* initialize_engine();
	extern "C" __declspec(dllexport) void shutdown_engine(engine::Engine* engine);
	extern "C" __declspec(dllexport) void update_engine(engine::Engine* engine, const platform::Input& input, platform::PlatformAPI* platform, platform::GraphicsAPI* graphics);
	...
	extern "C" __declspec(dllexport) void update_editor(editor::Editor* editor, const platform::Configuration& config, const platform::Input& input, engine::Engine* engine, platform::PlatformAPI* platform, platform::GraphicsAPI* graphics);
